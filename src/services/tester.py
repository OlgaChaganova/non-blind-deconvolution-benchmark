...
class Tester(object):
    """Tester for models evaluation in different scenarios (discritization type and noise)."""
    def __init__(
        self,
    ...
    def test(self):
        """
        Testing: float sRGB - (srgb2lin) -> float linear -> linear 16 bit - (linear2srgb) -> sRGB 8 bit.
        Works ONLY with images with float pixels.
        """
